...
public interface ClubRepository extends JpaRepository<Club, Integer> {
    /************************************************************************************************
     *  1 2 métodos de búsqueda usando nomenclatura Spring Data (findBy...) usando varias condiciones
     * @param nombre
     * @param ciudad
     * @return
     ************************************************************************************************/
    // Estos son metodos de busqueda los cuales , en mi caso van a servir para encontrar clubs por su nombre que esten en una ciudad concreta.
    List<Club> findByNombreContainingAndCiudad(String nombre, String ciudad);
    //este metodo busca clubs fundados antes de una fecha concreta en una ciudad concreta tambien.
